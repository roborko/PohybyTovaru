 ...
 */
public abstract class OrmLiteAppCompatActivity<H extends OrmLiteSqliteOpenHelper> extends AppCompatActivity {

    private volatile H helper;
    private volatile boolean created = false;
    private volatile boolean destroyed = false;
    private static Logger logger = LoggerFactory.getLogger(com.j256.ormlite.android.apptools.OrmLiteBaseActivity.class);
